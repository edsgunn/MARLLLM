...
# Config : /lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/15_high_rollouts.yaml
...
#SBATCH --job-name=high_rollouts
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --cpus-per-gpu=8
#SBATCH --time=20:00:00
#SBATCH --partition=workq
#SBATCH --output=/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/slurm_logs/high_rollouts_%j.out
#SBATCH --error=/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/slurm_logs/high_rollouts_%j.err
...
echo "Config file  : /lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/15_high_rollouts.yaml"
echo "================================================================"
...
echo "uv run --no-sync python "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/train_negotiation.py" --config "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/15_high_rollouts.yaml""
echo ""

uv run --no-sync python "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/train_negotiation.py" --config "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/15_high_rollouts.yaml"
EXIT_CODE=$?
