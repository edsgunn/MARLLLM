...
# Config : /lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/10_lr_sweep_high.yaml
...
#SBATCH --job-name=lr_sweep_high
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --cpus-per-gpu=8
#SBATCH --time=12:00:00
#SBATCH --partition=workq
#SBATCH --output=/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/slurm_logs/lr_sweep_high_%j.out
#SBATCH --error=/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/slurm_logs/lr_sweep_high_%j.err
...
echo "Config file  : /lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/10_lr_sweep_high.yaml"
echo "================================================================"
...
echo "uv run --no-sync python "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/train_negotiation.py" --config "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/10_lr_sweep_high.yaml""
echo ""

uv run --no-sync python "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/train_negotiation.py" --config "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/10_lr_sweep_high.yaml"
EXIT_CODE=$?
