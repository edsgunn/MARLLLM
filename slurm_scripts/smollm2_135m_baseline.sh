...
# Config : /lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/01_smollm2_135m_baseline.yaml
# Created: 2026-04-20T09:54:51
# ============================================================
#
# Hardware: GH200 Grace Hopper — 4 × 96 GB HBM3 GPU, ARM Grace CPU (aarch64)
# Docs   : https://docs.isambard.ac.uk

#SBATCH --job-name=smollm2_135m_baseline
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --cpus-per-gpu=72
#SBATCH --time=06:00:00
#SBATCH --partition=workq
#SBATCH --output=/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/slurm_logs/smollm2_135m_baseline_%j.out
#SBATCH --error=/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/slurm_logs/smollm2_135m_baseline_%j.err
...
echo "Config file  : /lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/01_smollm2_135m_baseline.yaml"
echo "================================================================"
...
echo "uv run --no-sync python "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/train_negotiation.py" --config "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/01_smollm2_135m_baseline.yaml""
echo ""

uv run --no-sync python "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/train_negotiation.py" --config "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/01_smollm2_135m_baseline.yaml"
EXIT_CODE=$?
