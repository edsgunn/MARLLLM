...
# Config : /lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/06_qwen_7b_lora_r64.yaml
# Created: 2026-04-20T09:54:52
# ============================================================
#
# Hardware: GH200 Grace Hopper — 4 × 96 GB HBM3 GPU, ARM Grace CPU (aarch64)
# Docs   : https://docs.isambard.ac.uk

#SBATCH --job-name=qwen_7b_lora_r64
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --cpus-per-gpu=8
#SBATCH --time=24:00:00
#SBATCH --partition=workq
#SBATCH --output=/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/slurm_logs/qwen_7b_lora_r64_%j.out
#SBATCH --error=/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/slurm_logs/qwen_7b_lora_r64_%j.err
...
echo "Config file  : /lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/06_qwen_7b_lora_r64.yaml"
echo "================================================================"
...
echo "uv run --no-sync python "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/train_negotiation.py" --config "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/06_qwen_7b_lora_r64.yaml""
echo ""

uv run --no-sync python "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/train_negotiation.py" --config "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/06_qwen_7b_lora_r64.yaml"
EXIT_CODE=$?
