...
# Config : /lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/16_asymmetric_agents.yaml
...
#SBATCH --job-name=asymmetric_agents
#SBATCH --nodes=1
#SBATCH --gpus=2
#SBATCH --cpus-per-gpu=72
#SBATCH --time=14:00:00
#SBATCH --partition=workq
#SBATCH --output=/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/slurm_logs/asymmetric_agents_%j.out
#SBATCH --error=/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/slurm_logs/asymmetric_agents_%j.err
...
echo "Config file  : /lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/16_asymmetric_agents.yaml"
echo "================================================================"
...
echo "uv run --no-sync python "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/train_negotiation.py" --config "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/16_asymmetric_agents.yaml""
echo ""

uv run --no-sync python "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/train_negotiation.py" --config "/lus/lfs1aip2/projects/a5l/egunn/projects/MARLLLM/configs/experiments/16_asymmetric_agents.yaml"
EXIT_CODE=$?
